...
cd /usr/bin
wget -O addss-p "https://raw.githubusercontent.com/jauhar-imtikhan/tunneling/master/shadowsocks-plugin/addss-p.sh"
chmod +x addss-p
wget -O delss "https://raw.githubusercontent.com/jauhar-imtikhan/tunneling/master/shadowsocks/delss.sh"
cd
